...
namespace Draughts
{
    public class CheckerBoardArray
    {
        ...
        public CheckerBoardArray serialization(GameInfo Gameinfo)
        {
            ...
            this.CheckerBoard[5][1] = Gameinfo.square39;
            this.CheckerBoard[5][3] = Gameinfo.square42;
            this.CheckerBoard[5][5] = Gameinfo.square44;
            this.CheckerBoard[5][7] = Gameinfo.square46;
            this.CheckerBoard[6][0] = Gameinfo.square48;
            this.CheckerBoard[6][2] = Gameinfo.square49;
            this.CheckerBoard[6][4] = Gameinfo.square51;
            this.CheckerBoard[6][6] = Gameinfo.square53;
            this.CheckerBoard[7][1] = Gameinfo.square55;
